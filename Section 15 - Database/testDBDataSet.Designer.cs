...
namespace Section_15___Database.testDBDataSetTableAdapters {
    ...
    public partial class ZooTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Zoo] SET [Id] = @Id, [Location] = @Location WHERE (([Id] = @Origina" +
                "l_Id) AND ((@IsNull_Location = 1 AND [Location] IS NULL) OR ([Location] = @Origi" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Section_15___Database.Properties.Settings.Default.testDBConnectionString;
        }
